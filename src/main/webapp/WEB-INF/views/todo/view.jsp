...
<head>
    <title></title>
    <script type="text/javascript" src="${url}/static/js/todo.view.js"></script>
</head>
<body>
    ...
    <div class="well page-content">
        ...
        <div class="action-buttons">
            <a href="${url }/todo/update/${todo.id}" class="btn btn-primary"><spring:message code="label.update.todo.link"/></a>
