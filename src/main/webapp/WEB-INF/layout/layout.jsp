...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${url}/static/css/example.css"/>
    ...
    <script type="text/javascript" src="${url}/static/js/vendor/jquery-1.8.2.js"></script>
    <script type="text/javascript" src="${url}/static/js/vendor/bootstrap.js"></script>
    <script type="text/javascript" src="${url}/static/js/vendor/bootstrap-transition.js"></script>
