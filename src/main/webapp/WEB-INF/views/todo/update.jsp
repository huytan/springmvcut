...
<head>
    <title></title>
    <script type="text/javascript" src="${url }/static/js/todo.form.js"></script>
</head>
<body>
    <h1><spring:message code="label.todo.update.page.title"/></h1>
    <div class="well page-content">
        <form:form action="${url}/todo/update" commandName="todo" method="POST" enctype="utf8">
            <form:hidden path="id"/>
            ...
            <div class="action-buttons">
                <a href="${url }/todo/${todo.id}" class="btn"><spring:message code="label.cancel"/></a>
